...
That same concept now powers caveman.cloud, where most conversations and user queries are already embedded. It's also used for clustering form inputs. ( the final version may be cosidered a self-supervised-learning approach)
## methodology 
